...
public class PartyRememberController {
  ...
  public Result del(@RequestBody PartyRemember partyRemember) {
    log.info("党员删除, uuid={}", partyRemember.getUuid());
    partyRememberService.deleteById(partyRemember.getUuid());
    return new Result<PartyRemember>(BusinessStatus.SUCCESS);
  }
}