...
import com.xl.backen.util.VerifyUtil;
...
public class ShortMessageServiceImpl implements ShortMessageService {
  ...
  public int verify(String phone) {
    // 给出的随机验证码
    String code = VerifyUtil.gennerator();
...
//替换成你的AK
    ...
    final String accessKeySecret = keySr;//你的accessKeySecret，参考本文档步骤2
//初始化ascClient,暂时不支持多region（请勿修改）
    ...
    //必填:短信签名-可在短信控制台中找到
    request.setSignName("远创微梦");
    //必填:短信模板-可在短信控制台中找到，发送国际/港澳台消息时，请使用国际/港澳台短信模版
    request.setTemplateCode("SMS_150742292");
